...
todo_comments.setup {
  ...
  keywords = {
    ...
    TODO = { icon = icons.ui.Check, color = hint, alt = { "TIP" } },
    HACK = { icon = icons.ui.Fire, color = warning },
    WARN = { icon = icons.diagnostics.Warning, color = warning, alt = { "WARNING", "XXX" } },
    PERF = { icon = icons.ui.Dashboard, color = perf, alt = { "OPTIM", "PERFORMANCE", "OPTIMIZE", "TEST" } },
    NOTE = { icon = icons.ui.Note, color = note, alt = { "INFO" } },
  },
