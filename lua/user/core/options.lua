...
set.updatetime = 250                        -- faster completion (default 4000)
...
set.foldmethod = "expr"                     -- the kind of folding used for the current window
set.foldenable = false                      -- folding at startup
...
set.showcmd = false                         -- show command in the last line of the screen
...
set.titlestring = "%{v:progname} - (%F)"    -- what the title of the window will be set to
